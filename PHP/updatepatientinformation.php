...
<form method="POST" id="updatepatientinformation" autocomplete="off" action="/HRCS/PHP/updatepatientinformation_Submit.php?matricnumber_up=<?php echo $getmatricnumber; ?>">
	...
	<input type="string" name="ic_number" id="name" placeholder="" value="<?php echo $icNumber ?>"><br><br>
